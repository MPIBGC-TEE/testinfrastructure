...
call  micromamba install -y -c conda-forge nbconvert jupytext # this requirement file is conda specific # it only lists those packages that are not extractable from setup.py # which are extracted by the installer automatically pip
...
call  micromamba install -y -c conda-forge matplotlib
